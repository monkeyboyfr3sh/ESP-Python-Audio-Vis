...
class ConvNext_Large(ModelWrapper):
    def __init__(self,device = 'cpu'):
        super().__init__(repo='pytorch/vision:v0.12.0',model_name='convnext_large',fpass=convnextdetect,device=device)

def convnextdetect(model,np_img,device='cpu'):
    ...
    edit_image = cv2.putText(edit_image,'ConvNext Large',(10, 50), cv2.FONT_HERSHEY_SIMPLEX,2,(255,0,0),2)
