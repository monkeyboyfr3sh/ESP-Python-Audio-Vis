...
class GoogleNet(ModelWrapper):
    def __init__(self,device = 'cpu'):
        super().__init__(repo='pytorch/vision:v0.12.0',model_name='googlenet',fpass=googlenetdetect,device=device)

def googlenetdetect(model,np_img,device='cpu'):
    ...
    edit_image = cv2.putText(edit_image,'GoogleNet',(10, 50), cv2.FONT_HERSHEY_SIMPLEX,2,(255,0,0),2)
