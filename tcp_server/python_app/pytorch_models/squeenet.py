...
class SqueezeNet(ModelWrapper):
    def __init__(self,device = 'cpu'):
        super().__init__(repo='pytorch/vision:v0.12.0',model_name='squeezenet1_1',fpass=squeezenetdetect,device=device)

def squeezenetdetect(model,np_img,device='cpu'):
    ...
    edit_image = cv2.putText(edit_image,'SqueezeNet',(10, 50), cv2.FONT_HERSHEY_SIMPLEX,2,(255,0,0),2)
